...
// https://docs.checkr.com/#tag/Federal-Criminal-Search
type FederalCriminalSearch struct {
	ID             string    `json:"id"`
	...
	Records        []struct {
		...
		ArrestingAgency   interface{} `json:"arresting_agency"`
...
// Unmarshal ...
func (f *FederalCriminalSearch) Unmarshal(b []byte) error {
